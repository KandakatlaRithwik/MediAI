...
from app.database.models import ChatHistory, Document, MedicalReportHistory, PatientHistory, User  # noqa: E402,F401

# this is the Alembic Config object, which provides
# access to the values within the .ini file in use.
config = context.config

# Use the app's own DATABASE_URL (from .env / environment) as the single
